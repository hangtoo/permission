...
INSERT INTO `module` VALUES (1,'0.1.1','模块管理','modulemanager/index.do',' ',2,'','\0',' ',1,' ',' ',0),(2,'0.1','基础配置',' ',' ',0,'','\0',' ',1,' ',' ',0),(4,'0.1.3','部门管理','orgmanager/index.do','',2,'\0','\0','',0,'基础配置','',0),(5,'0.1.4','角色管理','rolemanager/index.do','',2,'\0','\0','',0,'基础配置','',0),(6,'0.2','应用功能','/','',0,'\0','\0','',0,'根节点','',0),(7,'0.2.1','进出库管理','stockmanager/index.do','',6,'\0','\0','',0,'应用功能','',0),(8,'0.1.5','分类管理','categorymanager/index.do','',2,'\0','\0','',0,'基础配置','',0),(9,'0.1.2','用户管理','usermanager/index.do','',2,'\0','\0','',0,'基础配置','',0),(10,'0.1.6','资源管理','resourcemanager/index.do','',2,'\0','\0','',0,'基础配置','',0);
